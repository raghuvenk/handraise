...
while(True):
    ...
    frame = cv2.line(frame, (0, raiseHeight), (int(capWidth - 1), raiseHeight), (255, 255, 0), 1)
    if type(countours) == np.ndarray:
        ...
        if h < raiseHeight:
            ...
            frame = cv2.rectangle(frame, (max(w - faceWidth, 0), capHeight - 1), (w, raiseHeight - 1), (0, 0, 255), 2)
