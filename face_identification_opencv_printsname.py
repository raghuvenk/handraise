...
while(success):
    ...
    #drawing on the frame
            ...
            image = cv2.putText(image, currentStudent, (capWidth - marginx, marginy), font, 4, (255, 255, 255), 2, cv2.LINE_AA)
            ...
            if(count % countMod == 0):
                ...
                if(testFaceIDs != []):
                    ...
                    if(questionStudent != []):
                        currentStudent = questionStudent[0][1]
        else: currentStudent = ""
